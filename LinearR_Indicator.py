...
x_train_design = pd.get_dummies(x_train, drop_first=True, dtype=int)
x_test_design = pd.get_dummies(x_test, drop_first=True, dtype=int)
x_train_design.head()
...
y_hat_yes = beta0 + beta1 * x_space
#print(y_hat_yes)
print(beta2 * x_train_design[[best_cat_feature]].array)
# When categorical feature is false/absent (0)
#y_hat_no = beta0 + beta1 * x_space + beta2 * x_train_design[best_cat_feature]
